...
import (
	...
	"github.com/nttcom/eclcloud/ecl/identity/v3/endpoints"
	"github.com/nttcom/eclcloud/ecl/identity/v3/services"
)
...
func dataSourceIdentityEndpointV3Read(d *schema.ResourceData, meta interface{}) error {
	...
	availability := eclcloud.AvailabilityPublic
...
func dataSourceIdentityEndpointV3Attributes(d *schema.ResourceData, endpoint *endpoints.Endpoint) error {
	log.Printf("[DEBUG] ecl_identity_endpoint_v3 details: %#v", endpoint)
