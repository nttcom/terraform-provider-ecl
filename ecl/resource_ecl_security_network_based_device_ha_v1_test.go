...
func TestAccSecurityV1NetworkBasedDeviceHA_basic(t *testing.T) {
	if testing.Short() {
...
func TestAccSecurityV1NetworkBasedDeviceHA_updateInterface(t *testing.T) {
	if testing.Short() {
		t.Skip("skip this test in short mode")
	}
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			resource.TestStep{
				Config: testAccSecurityV1NetworkBasedDeviceHAIntrfaceUpdate,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSecurityV1NetworkBasedDeviceHAExists(
						"ecl_security_network_based_device_ha_v1.ha_1", &hd1, &hd2),
					testAccCheckNetworkV2NetworkExists("ecl_network_network_v2.network_1", &n1),
					...
					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_ha_v1.ha_1", "port.0.vrrp_ip_address", "10.0.0.50"),
					resource.TestCheckResourceAttrPtr(
						"ecl_security_network_based_device_ha_v1.ha_1", "port.0.network_id", &n3.ID),
					resource.TestCheckResourceAttrPtr(
						"ecl_security_network_based_device_ha_v1.ha_1", "port.0.subnet_id", &sn3.ID),
					resource.TestCheckResourceAttr(
					...
					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_ha_v1.ha_1", "port.0.host_1_ip_address", "10.0.0.51"),
					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_ha_v1.ha_1", "port.0.host_1_ip_address_prefix", "24"),
					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_ha_v1.ha_1", "port.0.host_2_ip_address", "10.0.0.52"),
					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_ha_v1.ha_1", "port.0.host_2_ip_address_prefix", "24"),

					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_ha_v1.ha_1", "port.3.vrrp_ip_address", "10.0.1.50"),
					resource.TestCheckResourceAttrPtr(
						"ecl_security_network_based_device_ha_v1.ha_1", "port.3.network_id", &n4.ID),
					resource.TestCheckResourceAttrPtr(
						"ecl_security_network_based_device_ha_v1.ha_1", "port.3.subnet_id", &sn4.ID),
					resource.TestCheckResourceAttr(
					...
					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_ha_v1.ha_1", "port.3.host_1_ip_address", "10.0.1.51"),
					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_ha_v1.ha_1", "port.3.host_1_ip_address_prefix", "24"),
					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_ha_v1.ha_1", "port.3.host_2_ip_address", "10.0.1.52"),
					resource.TestCheckResourceAttr(
			...
			resource.TestStep{
				Config: testAccSecurityV1NetworkBasedDeviceHAIntrfaceDisconnect,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSecurityV1NetworkBasedDeviceHAExists(
						"ecl_security_network_based_device_ha_v1.ha_1", &hd1, &hd2),
					testAccCheckNetworkV2NetworkExists("ecl_network_network_v2.network_1", &n1),
...
const testAccSecurityV1NetworkBasedDeviceUserNetworkSubnet1 = `
...
`
const testAccSecurityV1NetworkBasedDeviceUserNetworkSubnet2 = `
