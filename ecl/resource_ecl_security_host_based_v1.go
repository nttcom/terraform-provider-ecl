...
func resourceSecurityHostBasedV1() *schema.Resource {
	return &schema.Resource{
		Create: resourceSecurityHostBasedV1Create,
		Read:   resourceSecurityHostBasedV1Read,
		Update: resourceSecurityHostBasedV1Update,
		Delete: resourceSecurityHostBasedV1Delete,
...
func resourceSecurityHostBasedV1Create(d *schema.ResourceData, meta interface{}) error {
	config := meta.(*Config)
	...
	return resourceSecurityHostBasedV1Read(d, meta)
}

func resourceSecurityHostBasedV1Read(d *schema.ResourceData, meta interface{}) error {
	config := meta.(*Config)
...
func resourceSecurityHostBasedV1UpdateServiceOrderService(d *schema.ResourceData, meta interface{}) error {
	config := meta.(*Config)
	client, err := config.securityOrderV1Client(GetRegion(d, config))
	if err != nil {
		return fmt.Errorf("Error creating ECL security order client: %s", err)
...
func resourceSecurityHostBasedV1UpdateMaxAgentValue(d *schema.ResourceData, meta interface{}) error {
	config := meta.(*Config)
	client, err := config.securityOrderV1Client(GetRegion(d, config))
	if err != nil {
		return fmt.Errorf("Error creating ECL security order client: %s", err)
...
func resourceSecurityHostBasedV1Update(d *schema.ResourceData, meta interface{}) error {

	if d.HasChange("service_order_service") {
		resourceSecurityHostBasedV1UpdateServiceOrderService(d, meta)
	}

	if d.HasChange("max_agent_value") {
		resourceSecurityHostBasedV1UpdateMaxAgentValue(d, meta)
	}

	return resourceSecurityHostBasedV1Read(d, meta)
}

func resourceSecurityHostBasedV1Delete(d *schema.ResourceData, meta interface{}) error {
	config := meta.(*Config)
	client, err := config.securityOrderV1Client(GetRegion(d, config))
	if err != nil {
		return fmt.Errorf("Error creating ECL security order client: %s", err)
