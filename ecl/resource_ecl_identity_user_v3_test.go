		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIdentityV3UserExists("ecl_identity_user_v3.user_1", &user),
					testAccCheckIdentityV3ProjectExists("ecl_identity_project_v3.project_1", &project),
					resource.TestCheckResourceAttrPtr(
						"ecl_identity_user_v3.user_1", "name", &user.Name),
					resource.TestCheckResourceAttrPtr(
						"ecl_identity_user_v3.user_1", "description", &user.Description),
					resource.TestCheckResourceAttr(
						"ecl_identity_user_v3.user_1", "enabled", "true"),
					resource.TestCheckResourceAttr(
					...
					resource.TestCheckResourceAttr(
						"ecl_identity_user_v3.user_1", "multi_factor_auth_rule.0.rule.0", "password"),
					resource.TestCheckResourceAttr(
						"ecl_identity_user_v3.user_1", "multi_factor_auth_rule.0.rule.1", "totp"),
					resource.TestCheckResourceAttr(
						"ecl_identity_user_v3.user_1", "multi_factor_auth_rule.1.rule.0", "password"),
					resource.TestCheckResourceAttr(
						"ecl_identity_user_v3.user_1", "multi_factor_auth_rule.1.rule.1", "custom-auth-method"),
					resource.TestCheckResourceAttr(
						"ecl_identity_user_v3.user_1", "extra.email", "jdoe@example.com"),
				),
			},
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPtr(
						"ecl_identity_user_v3.user_1", "description", &user.Description),
					resource.TestCheckResourceAttr(
						"ecl_identity_user_v3.user_1", "enabled", "false"),
					resource.TestCheckResourceAttr(
						"ecl_identity_user_v3.user_1", "ignore_change_password_upon_first_use", "false"),
					resource.TestCheckResourceAttr(
						"ecl_identity_user_v3.user_1", "multi_factor_auth_rule.#", "1"),
					resource.TestCheckResourceAttr(
						"ecl_identity_user_v3.user_1", "multi_factor_auth_rule.0.rule.0", "password"),
					resource.TestCheckResourceAttr(
						"ecl_identity_user_v3.user_1", "multi_factor_auth_rule.0.rule.1", "totp"),
					resource.TestCheckResourceAttr(
						"ecl_identity_user_v3.user_1", "extra.email", "jdoe@foobar.com"),
				),
			},
		},
	})
