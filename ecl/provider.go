...
func Provider() terraform.ResourceProvider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"ecl_security_host_based_v2":                             resourceSecurityHostBasedV2(),
			"ecl_security_network_based_device_ha_v2":                resourceSecurityNetworkBasedDeviceHAV2(),
			"ecl_security_network_based_device_single_v2":            resourceSecurityNetworkBasedDeviceSingleV2(),
			"ecl_security_network_based_waf_single_v2":               resourceSecurityNetworkBasedWAFSingleV2(),
