...
import (
	...
	"github.com/nttcom/eclcloud/ecl/objectstorage/v1/objects"
)
			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckObjectStorageV1ObjectExists(
						"ecl_objectstorage_object_v1.myfile", &object),
					testAccCheckObjectStorageV1ObjectDeleteAtMatches(deleteAt, &object),
					resource.TestCheckResourceAttr(
						"ecl_objectstorage_container_v1.container_1", "name", "tf_test_container_1"),
					resource.TestCheckResourceAttr(
						"ecl_objectstorage_object_v1.myfile", "content_type", "text/plain"),
					resource.TestCheckResourceAttr(
						"ecl_objectstorage_object_v1.myfile", "content_length", "3"),
					resource.TestCheckResourceAttr(
						"ecl_objectstorage_object_v1.myfile", "content_disposition", "foo"),
					resource.TestCheckResourceAttr(
						"ecl_objectstorage_object_v1.myfile", "content_encoding", "utf8"),
					resource.TestCheckResourceAttr(
						"ecl_objectstorage_object_v1.myfile", "etag", fooMD5),
				),
			},
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"ecl_objectstorage_object_v1.myfile", "content_type", "application/octet-stream"),
				),
			},
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"ecl_objectstorage_object_v1.myfile", "content_type", "application/octet-stream"),
					resource.TestCheckResourceAttr(
						"ecl_objectstorage_object_v1.myfile", "etag", foobarMD5),
					resource.TestCheckResourceAttr(
						"ecl_objectstorage_object_v1.myfile", "content_length", "6"),
				),
			},
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"ecl_objectstorage_object_v1.myfile", "delete_after", "3600"),
				),
			},
		},
	})
			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"ecl_objectstorage_object_v1.myfile", "content_type", "text/plain"),
					resource.TestCheckResourceAttr(
						"ecl_objectstorage_object_v1.myfile", "content_length", fmt.Sprintf("%v", len(content))),
					resource.TestCheckResourceAttr(
						"ecl_objectstorage_object_v1.myfile", "etag", fooMD5),
				),
			},
			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"ecl_objectstorage_container_v1.container_1", "name", "tf_test_container_1"),
					resource.TestCheckResourceAttr(
						"ecl_objectstorage_object_v1.myfile", "content_type", "text/csv"),
					resource.TestCheckResourceAttr(
						"ecl_objectstorage_object_v1.myfile", "etag", fooMD5),
				),
			},
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"ecl_objectstorage_object_v1.myfilesource", "etag", fooMD5),
					resource.TestCheckResourceAttr(
						"ecl_objectstorage_object_v1.myfilecopied", "etag", fooMD5),
				),
			},
		},
	})
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"ecl_objectstorage_object_v1.myfile_part1", "etag", fooMD5),
					resource.TestCheckResourceAttr(
						"ecl_objectstorage_object_v1.myfile_part2", "etag", barMD5),
					resource.TestCheckResourceAttr(
						"ecl_objectstorage_object_v1.myfile", "etag", manifestMD5),
				),
			},
		},
	})
...
func testAccCheckObjectStorageV1ObjectDestroy(s *terraform.State, objectname string) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "ecl_objectstorage_object_v1" {
			continue
		}
...
resource "ecl_objectstorage_object_v1" "myfile" {
  name = "terraform/test/myfile.txt"
  container_name = "${ecl_objectstorage_container_v1.container_1.name}"
  content = "foo"
...
resource "ecl_objectstorage_object_v1" "myfilesource" {
  name = "terraform/test/myfile.txt"
  container_name = "${ecl_objectstorage_container_v1.container_1.name}"
  content = "foo"
}

resource "ecl_objectstorage_object_v1" "myfilecopied" {
  name = "terraform/test/myfilecopied.txt"
  container_name = "${ecl_objectstorage_container_v1.container_1.name}"
  copy_from = "${ecl_objectstorage_container_v1.container_1.name}/${ecl_objectstorage_object_v1.myfilesource.name}"
}
`
...
resource "ecl_objectstorage_object_v1" "myfile_part1" {
  name = "terraform/test.csv/part001"
  container_name = "${ecl_objectstorage_container_v1.container_1.name}"
  content = "foo"
}
resource "ecl_objectstorage_object_v1" "myfile_part2" {
...
resource "ecl_objectstorage_object_v1" "myfile" {
  ...
  container_name = "${ecl_objectstorage_container_v1.container_1.name}"
  object_manifest = "${format("%s/terraform/test.csv/part",ecl_objectstorage_container_v1.container_1.name)}"
}
`
