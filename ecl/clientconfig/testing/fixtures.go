...
var HawaiiAuthOpts = &eclcloud.AuthOptions{
	Scope: &eclcloud.AuthScope{
		ProjectName: "Some Project",
		DomainName:  "default",
	},
...
var FloridaAuthOpts = &eclcloud.AuthOptions{
	Scope: &eclcloud.AuthScope{
		ProjectID: "12345",
	},
...
var CaliforniaAuthOpts = &eclcloud.AuthOptions{
	Scope: &eclcloud.AuthScope{
		ProjectName: "Some Project",
		DomainName:  "default",
	},
...
var ArizonaAuthOpts = &eclcloud.AuthOptions{
	Scope: &eclcloud.AuthScope{
		ProjectName: "Some Project",
		DomainName:  "default",
	},
...
var NewMexicoAuthOpts = &eclcloud.AuthOptions{
	Scope: &eclcloud.AuthScope{
		ProjectName: "Some Project",
...
var NevadaAuthOpts = &eclcloud.AuthOptions{
	Scope: &eclcloud.AuthScope{
		ProjectName: "Some Project",
		DomainName:  "Some Domain",
	},
...
var TexasAuthOpts = &eclcloud.AuthOptions{
	Scope: &eclcloud.AuthScope{
		ProjectName: "Some Project",
		DomainID:    "default",
	},
...
var AlbertaAuthOpts = &eclcloud.AuthOptions{
...
var YukonAuthOpts = &eclcloud.AuthOptions{
