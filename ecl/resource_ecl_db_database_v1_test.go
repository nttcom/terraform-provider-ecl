...
import (
	...
	"github.com/nttcom/eclcloud/ecl/db/v1/databases"
			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckDatabaseV1DatabaseExists(
						"ecl_db_database_v1.basic", &instance, &db),
					resource.TestCheckResourceAttrPtr(
						"ecl_db_database_v1.basic", "name", &db.Name),
				),
			},
		},
	})
...
resource "ecl_db_database_v1" "basic" {
  name        = "basic"
  instance_id = "${ecl_db_instance_v1.basic.id}"
}
