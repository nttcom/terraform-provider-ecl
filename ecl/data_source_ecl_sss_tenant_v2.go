...
func dataSourceSSSTenantV2() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceSSSTenantV2Read,
...
// dataSourceSSSTenantV2Read performs the project lookup.
func dataSourceSSSTenantV2Read(d *schema.ResourceData, meta interface{}) error {
	config := meta.(*Config)
