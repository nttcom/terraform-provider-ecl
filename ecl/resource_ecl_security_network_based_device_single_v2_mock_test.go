...
func TestMockedAccSecurityV2NetworkBasedDeviceSingle_basic(t *testing.T) {
	...
	mc.Register(t, "single_device", "/API/ScreenEventFGSOrderProgressRate", testMockSecurityV2NetworkBasedDeviceSingleGetProcessingAfterUpdate)
	mc.Register(t, "single_device", "/API/ScreenEventFGSOrderProgressRate", testMockSecurityV2NetworkBasedDeviceSingleGetCompleteActiveAfterUpdate)
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			resource.TestStep{
				Config: testMockedAccSecurityV2NetworkBasedDeviceSingleUpdate,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSecurityV2NetworkBasedDeviceSingleExists(
						"ecl_security_network_based_device_single_v2.device_1", &sd),
					resource.TestCheckResourceAttr(
...
func TestMockedAccSecurityV2NetworkBasedDeviceSingleUpdateInterface(t *testing.T) {
	var sd security.SingleDevice
	...
	mc.Register(t, "single_device", "/API/ScreenEventFGSDeviceGet", testMockSecurityV2NetworkBasedDeviceSingleListAfterCreate)
	mc.Register(t, "single_device", "/ecl-api/devices", testMockSecurityV2NetworkBasedDeviceSingleListDevicesAfterCreate)
	mc.Register(t, "single_device", fmt.Sprintf("/ecl-api/devices/%s/interfaces", expectedNewSingleDeviceUUID), testMockSecurityV2NetworkBasedDeviceSingleListDeviceInterfacesAfterCreate)
	...
	mc.Register(t, "single_device", fmt.Sprintf("/ecl-api/process/%d/status", ProcessIDOfUpdateInterface), testMockSecurityV2NetworkBasedDeviceSingleGetProcessingAfterUpdateInterface)
	mc.Register(t, "single_device", fmt.Sprintf("/ecl-api/process/%d/status", ProcessIDOfUpdateInterface), testMockSecurityV2NetworkBasedDeviceSingleGetCompleteActiveAfterUpdateInterface)
	mc.Register(t, "single_device", "/API/ScreenEventFGSDeviceGet", testMockSecurityV2NetworkBasedDeviceSingleListAfterInterfaceUpdate)
	mc.Register(t, "single_device", "/ecl-api/devices", testMockSecurityV2NetworkBasedDeviceSingleListDevicesAfterUpdate)
	mc.Register(t, "single_device", fmt.Sprintf("/ecl-api/devices/%s/interfaces", expectedNewSingleDeviceUUID), testMockSecurityV2NetworkBasedDeviceSingleListDeviceInterfacesAfterUpdate)
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			resource.TestStep{
				Config: testMockedAccSecurityV2NetworkBasedDeviceSingleUpdateInterface,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSecurityV2NetworkBasedDeviceSingleExists(
						"ecl_security_network_based_device_single_v2.device_1", &sd),
					...
					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_single_v2.device_1", "port.0.network_id", "dummyNetwork1"),
					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_single_v2.device_1", "port.0.subnet_id", "dummySubnet1"),
					resource.TestCheckResourceAttr(
					...
					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_single_v2.device_1", "port.3.network_id", "dummyNetwork2"),
					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_single_v2.device_1", "port.3.subnet_id", "dummySubnet2"),
					resource.TestCheckResourceAttr(
...
var testMockedAccSecurityV2NetworkBasedDeviceSingleBasic = fmt.Sprintf(`
...
var testMockedAccSecurityV2NetworkBasedDeviceSingleUpdate = fmt.Sprintf(`
resource "ecl_security_network_based_device_single_v2" "device_1" {
	tenant_id = "%s"
	locale = "en"
	operating_mode = "UTM"
...
var testMockedAccSecurityV2NetworkBasedDeviceSingleUpdateInterface = fmt.Sprintf(`
...
var testMockSecurityV2NetworkBasedDeviceSingleListBeforeCreate = fmt.Sprintf(`
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceSingleListAfterCreate = fmt.Sprintf(`
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceSingleListDeviceInterfaces = `
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceSingleListDevicesAfterCreate = fmt.Sprintf(`
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceSingleListDevicesAfterUpdate = fmt.Sprintf(`
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceSingleListDeviceInterfacesAfterCreate = `
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceSingleListDeviceInterfacesAfterUpdate = `
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceSingleListAfterDelete = fmt.Sprintf(`
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceSingleCreate = fmt.Sprintf(`
request:
    method: POST
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceSingleGetCompleteActiveAfterCreate = `
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceSingleDelete = fmt.Sprintf(`
request:
    method: POST
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceSingleProcessingAfterDelete = `
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceSingleGetDeleteComplete = `
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceSingleUpdate = fmt.Sprintf(`
request:
    method: POST
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceSingleGetProcessingAfterUpdate = `
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceSingleGetCompleteActiveAfterUpdate = `
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceSingleListAfterUpdate = fmt.Sprintf(`
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceSingleListAfterInterfaceUpdate = fmt.Sprintf(`
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceSingleUpdateInterface = fmt.Sprintf(`
request:
    method: PUT
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceSingleGetProcessingAfterUpdateInterface = `
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceSingleGetCompleteActiveAfterUpdateInterface = `
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceSingleListAfterUpdateInterface = fmt.Sprintf(`
request:
    method: GET
response:
    code: 200
