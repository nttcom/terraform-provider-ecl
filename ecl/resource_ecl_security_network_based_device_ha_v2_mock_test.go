...
func TestMockedAccSecurityV2NetworkBasedDeviceHA_basic(t *testing.T) {
	...
	mc.Register(t, "ha_device", "/API/SoEntryFGHA", testMockSecurityV2NetworkBasedDeviceHAUpdate)
	mc.Register(t, "ha_device", "/API/ScreenEventFGSOrderProgressRate", testMockSecurityV2NetworkBasedDeviceHAGetProcessingAfterUpdate)
	mc.Register(t, "ha_device", "/API/ScreenEventFGSOrderProgressRate", testMockSecurityV2NetworkBasedDeviceHAGetCompleteActiveAfterUpdate)
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			resource.TestStep{
				Config: testMockedAccSecurityV2NetworkBasedDeviceHAUpdate,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSecurityV2NetworkBasedDeviceHAExists(
						"ecl_security_network_based_device_ha_v2.ha_1", &hd1, &hd2),
					resource.TestCheckResourceAttr(
...
func TestMockedAccSecurityV2NetworkBasedDeviceHAUpdateInterface(t *testing.T) {
	var hd1, hd2 security.HADevice
	...
	mc.Register(t, "ha_device", "/API/ScreenEventFGHADeviceGet", testMockSecurityV2NetworkBasedDeviceHAListAfterCreate)
	mc.Register(t, "ha_device", "/ecl-api/devices", testMockSecurityV2NetworkBasedDeviceHAListDevicesAfterCreate)
	mc.Register(t, "ha_device", fmt.Sprintf("/ecl-api/devices/%s/interfaces", expectedNewHADeviceUUID1), testMockSecurityV2NetworkBasedDeviceHAListDeviceInterfacesAfterCreate)
	mc.Register(t, "ha_device", fmt.Sprintf("/ecl-api/devices/%s/interfaces", expectedNewHADeviceUUID2), testMockSecurityV2NetworkBasedDeviceHAListDeviceInterfacesAfterCreate)
	...
	mc.Register(t, "ha_device", "/API/ScreenEventFGHADeviceGet", testMockSecurityV2NetworkBasedDeviceHAListAfterInterfaceUpdate)
	mc.Register(t, "ha_device", "/ecl-api/devices", testMockSecurityV2NetworkBasedDeviceHAListDevicesAfterUpdate)
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			resource.TestStep{
				Config: testMockedAccSecurityV2NetworkBasedDeviceHAUpdateInterface,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSecurityV2NetworkBasedDeviceHAExists(
						"ecl_security_network_based_device_ha_v2.ha_1", &hd1, &hd2),

					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_ha_v2.ha_1", "port.0.vrrp_ip_address", "192.168.1.50"),
					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_ha_v2.ha_1", "port.0.network_id", "dummyNetwork-port1"),
					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_ha_v2.ha_1", "port.0.subnet_id", "dummySubnet-port1"),
					resource.TestCheckResourceAttr(
					...
					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_ha_v2.ha_1", "port.0.host_1_ip_address", "10.0.0.1"),
					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_ha_v2.ha_1", "port.0.host_1_ip_address_prefix", "24"),
					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_ha_v2.ha_1", "port.0.host_2_ip_address", "10.0.0.2"),
					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_ha_v2.ha_1", "port.0.host_2_ip_address_prefix", "24"),

					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_ha_v2.ha_1", "port.3.vrrp_ip_address", "192.168.1.51"),
					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_ha_v2.ha_1", "port.3.network_id", "dummyNetwork-port2"),
					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_ha_v2.ha_1", "port.3.subnet_id", "dummySubnet-port2"),
					resource.TestCheckResourceAttr(
					...
					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_ha_v2.ha_1", "port.3.host_1_ip_address", "10.0.0.3"),
					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_ha_v2.ha_1", "port.3.host_1_ip_address_prefix", "24"),
					resource.TestCheckResourceAttr(
						"ecl_security_network_based_device_ha_v2.ha_1", "port.3.host_2_ip_address", "10.0.0.4"),
					resource.TestCheckResourceAttr(
...
var testMockedAccSecurityV2NetworkBasedDeviceHABasic = fmt.Sprintf(`
...
var testMockedAccSecurityV2NetworkBasedDeviceHAUpdate = fmt.Sprintf(`
resource "ecl_security_network_based_device_ha_v2" "ha_1" {
	tenant_id = "%s"
	locale = "en"
	operating_mode = "UTM_HA"
...
var testMockedAccSecurityV2NetworkBasedDeviceHAUpdateInterface = fmt.Sprintf(`
...
var testMockSecurityV2NetworkBasedDeviceHAListDeviceInterfaces = `
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceHAListBeforeCreate = fmt.Sprintf(`
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceHAListAfterCreate = fmt.Sprintf(`
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceHAListDevicesAfterCreate = fmt.Sprintf(`
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceHAListDevicesAfterUpdate = fmt.Sprintf(`
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceHAListDeviceInterfacesAfterCreate = `
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceHAListDeviceInterfacesOfHost1AfterUpdate = `
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceHAListDeviceInterfacesOfHost2AfterUpdate = `
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceHAListAfterDelete = fmt.Sprintf(`
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceHACreate = fmt.Sprintf(`
request:
    method: POST
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceHAGetProcessingAfterCreate = `
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceHAGetCompleteActiveAfterCreate = `
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceHADelete = fmt.Sprintf(`
request:
    method: POST
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceHAProcessingAfterDelete = `
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceHAGetDeleteComplete = `
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceHAUpdate = fmt.Sprintf(`
request:
    method: POST
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceHAGetProcessingAfterUpdate = `
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceHAGetCompleteActiveAfterUpdate = `
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceHAListAfterUpdate = fmt.Sprintf(`
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceHAListAfterInterfaceUpdate = fmt.Sprintf(`
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceHAUpdateInterface = fmt.Sprintf(`
request:
    method: PUT
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceHAGetProcessingAfterUpdateInterface = `
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceHAGetCompleteActiveAfterUpdateInterface = `
request:
    method: GET
response:
    code: 200
...
var testMockSecurityV2NetworkBasedDeviceHAListAfterUpdateInterface = fmt.Sprintf(`
request:
    method: GET
response:
    code: 200
