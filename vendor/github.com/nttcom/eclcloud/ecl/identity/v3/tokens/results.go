...
type CatalogEntry struct {
	...
	// Type will contain a type string if Enterprise Cloud defines a type for the
...
// in an Enterprise Cloud provider. Each Token is valid for a set length of time.
type Token struct {
