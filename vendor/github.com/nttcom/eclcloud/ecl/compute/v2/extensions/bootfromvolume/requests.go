...
func (opts CreateOptsExt) ToServerCreateMap() (map[string]interface{}, error) {
	...
	for i, bd := range opts.BlockDevice {
		b, err := eclcloud.BuildRequestBody(bd, "")
		if err != nil {
			return nil, err
		}
		blockDevice[i] = b
...
func Create(client *eclcloud.ServiceClient, opts servers.CreateOptsBuilder) (r servers.CreateResult) {
