...
func (opts ResizeOpts) ToServerResizeMap() (map[string]interface{}, error) {
	return eclcloud.BuildRequestBody(opts, "resize")
}
...
func ResetMetadata(client *eclcloud.ServiceClient, id string, opts ResetMetadataOptsBuilder) (r ResetMetadataResult) {
	...
	_, r.Err = client.Put(metadataURL(client, id), b, &r.Body, &eclcloud.RequestOpts{
		OkCodes: []int{200},
	})
	return
}
...
func UpdateMetadata(client *eclcloud.ServiceClient, id string, opts UpdateMetadataOptsBuilder) (r UpdateMetadataResult) {
	...
	_, r.Err = client.Post(metadataURL(client, id), b, &r.Body, &eclcloud.RequestOpts{
		OkCodes: []int{200},
	})
	return
}
...
func CreateMetadatum(client *eclcloud.ServiceClient, id string, opts MetadatumOptsBuilder) (r CreateMetadatumResult) {
	...
	_, r.Err = client.Put(metadatumURL(client, id, key), b, &r.Body, &eclcloud.RequestOpts{
		OkCodes: []int{200},
	})
	return
}
...
func (opts CreateImageOpts) ToServerCreateImageMap() (map[string]interface{}, error) {
	return eclcloud.BuildRequestBody(opts, "createImage")
}
...
func CreateImage(client *eclcloud.ServiceClient, id string, opts CreateImageOptsBuilder) (r CreateImageResult) {
	...
	resp, err := client.Post(actionURL(client, id), b, nil, &eclcloud.RequestOpts{
		OkCodes: []int{202},
	})
	r.Err = err
...
func IDFromName(client *eclcloud.ServiceClient, name string) (string, error) {
	...
	switch count {
	case 0:
		return "", eclcloud.ErrResourceNotFound{Name: name, ResourceType: "server"}
	case 1:
		return id, nil
	default:
