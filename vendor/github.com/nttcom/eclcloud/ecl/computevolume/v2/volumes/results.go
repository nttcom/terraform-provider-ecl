...
func (r *Attachment) UnmarshalJSON(b []byte) error {
	...
	var s struct {
		tmp
		AttachedAt eclcloud.JSONRFC3339MilliNoZ `json:"attached_at"`
	}
...
// Volume contains all the information associated with an Enterprise Cloud Volume.
type Volume struct {
...
func (r VolumePage) NextPageURL() (string, error) {
	var s struct {
		Links []eclcloud.Link `json:"volumes_links"`
	}
	err := r.ExtractInto(&s)
	if err != nil {
		return "", err
