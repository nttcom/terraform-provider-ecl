...
func Request(client *eclcloud.ServiceClient, headers map[string]string, url string) (*http.Response, error) {
	return client.Get(url, nil, &eclcloud.RequestOpts{
		MoreHeaders: headers,
