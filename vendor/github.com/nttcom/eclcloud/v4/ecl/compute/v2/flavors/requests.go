...
/*
	AccessType maps to Enterprise Cloud's Flavor.is_public field. Although the is_public
	field is boolean, the request options are ternary, which is why AccessType is
	a string. The following values are allowed:

	The AccessType arguement is optional, and if it is not supplied, Enterprise Cloud
...
// ListDetail instructs Enterprise Cloud to provide a list of flavors.
...
// 	return eclcloud.BuildRequestBody(opts, "flavor")
// }
...
// func ListAccesses(client *eclcloud.ServiceClient, id string) pagination.Pager {
...
// 	return eclcloud.BuildRequestBody(opts, "addTenantAccess")
// }

// // AddAccess grants a tenant/project access to a flavor.
// func AddAccess(client *eclcloud.ServiceClient, id string, opts AddAccessOptsBuilder) (r AddAccessResult) {
// 	b, err := opts.ToFlavorAddAccessMap()
// 	if err != nil {
// 		r.Err = err
// 		return
// 	}
// 	_, r.Err = client.Post(accessActionURL(client, id), b, &r.Body, &eclcloud.RequestOpts{
// 		OkCodes: []int{200},
// 	})
// 	return
// }
...
// 	return eclcloud.BuildRequestBody(opts, "removeTenantAccess")
// }

// // RemoveAccess removes/revokes a tenant/project access to a flavor.
// func RemoveAccess(client *eclcloud.ServiceClient, id string, opts RemoveAccessOptsBuilder) (r RemoveAccessResult) {
...
// func ListExtraSpecs(client *eclcloud.ServiceClient, flavorID string) (r ListExtraSpecsResult) {
// 	_, r.Err = client.Get(extraSpecsListURL(client, flavorID), &r.Body, nil)
// 	return
// }

// func GetExtraSpec(client *eclcloud.ServiceClient, flavorID string, key string) (r GetExtraSpecResult) {
...
// func CreateExtraSpecs(client *eclcloud.ServiceClient, flavorID string, opts CreateExtraSpecsOptsBuilder) (r CreateExtraSpecsResult) {
// 	b, err := opts.ToFlavorExtraSpecsCreateMap()
// 	if err != nil {
// 		r.Err = err
// 		return
// 	}
// 	_, r.Err = client.Post(extraSpecsCreateURL(client, flavorID), b, &r.Body, &eclcloud.RequestOpts{
// 		OkCodes: []int{200},
// 	})
// 	return
// }
...
// // for the key in opts.
// func UpdateExtraSpec(client *eclcloud.ServiceClient, flavorID string, opts UpdateExtraSpecOptsBuilder) (r UpdateExtraSpecResult) {
// 	b, key, err := opts.ToFlavorExtraSpecUpdateMap()
// 	if err != nil {
// 		r.Err = err
// 		return
// 	}
// 	_, r.Err = client.Put(extraSpecUpdateURL(client, flavorID, key), b, &r.Body, &eclcloud.RequestOpts{
// 		OkCodes: []int{200},
// 	})
// 	return
// }
...
// flavor ID.
// func DeleteExtraSpec(client *eclcloud.ServiceClient, flavorID, key string) (r DeleteExtraSpecResult) {
// 	_, r.Err = client.Delete(extraSpecDeleteURL(client, flavorID, key), &eclcloud.RequestOpts{
// 		OkCodes: []int{200},
// 	})
// 	return
// }
